@extends('layouts.master') @section('title') {{trans('client.data')}} @endsection
@section('css')
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="d-flex right-content">
                            <div class="pr-1 mb-3 mb-xl-0">
                                <a class="btn btn-success-gradient btn-sm float-left" href="{{route('print_client_balance',$client->id)}}">
...
<br>
                ...
                <div class="table-responsive">
                    <table id="example2" class="table key-buttons text-md-nowrap report_table text-center" style="width: 98%">
