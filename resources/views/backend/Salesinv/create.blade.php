    ...
    <div class="col-xl-12 text-center justify-center align-middle">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                @include('backend.Salesinv.Approve_inv')
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form method="POST">
                            @method('POST')
                            <button onclick="approve_invoice_data()" data-target="#approve_invoice" data-toggle="modal"
                                tabindex="0" aria-controls="example" type="button"
                                class="btn btn-success btn-block btn-sm tx-15 tx-bold py-2">{{ trans('general.save') }}<i
                            ...
                            <input type="hidden" value="{{ route('salesinvoice_getapprovedata') }}" id="approve_link">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-6">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="id" class="form-control" id="inv_id" name="id" readonly
                                    value="{{ $data['sales_invoice']->id }}">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="input-group input-group-sm">
                                <label for="name" class="input-group-text">{{ trans('invoice.client_name') }}</label>
                        ...
                        <form method="POST" autocomplete='off'>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12"> <input type="number"
                                        placeholder="{{ trans('invoice.quantity') }}" class="form-control" id="quantity"
                                        value="1"></div>
                            </div>
