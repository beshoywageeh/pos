            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-12 col-md-6">
                        <a href="{{route('product.create')}}" class="btn btn-success buttons-add btn-with-icon buttons-html5 tx-15 tx-bold"><i class="typcn typcn-document-add"></i><span>{{ trans('general.add') }}</span></a>
                    </div>
                    <div class="col-md-6">
                        <form method="POST">
                    ...
                    <table class="table table-bordered table-striped mg-b-0 text-md-nowrap text-center tx-15 tx-bold">
                        ...
                        @forelse($products as $product)
                            <tr role="row">
                                ...
                                <td>
                                    <svg class="barcode_index img-responsive" jsbarcode-value="{{ $product->barcode}}"
                                         jsbarcode-displayvalue="false" jsbarcode-height="10"></svg>
                                </td>
                                <td>{{ $product->name }}</td>
                                <td>{{ $product->price }}</td>
