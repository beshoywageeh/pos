        ...
        <div class="card mg-b-20">
            ...
            <form action="{{ route('product.store') }}" method="POST" autocomplete="off" id="product_data">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type='number' class="form-control @error('opening_balance') is-invalid @enderror"
                                    name="opening_balance" placeholder="{{ trans('product.opening_balance') }}"
                                    id="opening_balance">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror" name="notes" id="Note" rows="5"
                                    placeholder="{{ trans('product.note') }}"></textarea>
                                @error('notes')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card-footer">
                    <button class="btn ripple btn-primary" type="submit" id='submit_proudct'>{{ trans('general.save') }} </button>
                </div>
            </form>
        </div>
    </div>
