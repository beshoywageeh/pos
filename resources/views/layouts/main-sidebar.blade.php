        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">{{trans('invoice.invoice')}}</span><i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('sales.index') }}">{{trans('invoice.salesinvoce')}}</a></li>
                    <li><a class="slide-item" href="{{ route('sales.index') }}">{{trans('invoice.rejctsalesinvoice')}}</a></li>
                    <li><a class="slide-item" href="{{ route('sales.index') }}">{{trans('invoice.supplyinvoce')}}</a></li>
                    <li><a class="slide-item" href="{{ route('sales.index') }}">{{trans('invoice.rejctsupplyinvoice')}}</a></li>
                </ul>
            </li>
